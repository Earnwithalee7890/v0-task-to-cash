...
export function HomePage({ userData, onAddToMiniApp, onShare }: HomePageProps) {
    return (
        <div className="space-y-4 pb-20">
            ...
            {/* Action Buttons */}
            <div className="space-y-3 opacity-0 animate-slide-up stagger-4">
                {/* Add & Share Buttons */}
                ...
                <button
                    ...
                    className="group relative w-full flex items-center justify-center gap-3 h-12 rounded-xl bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border border-primary/20 text-primary font-bold shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] overflow-hidden"
                >
                    ...
                    <div className="relative">
                        <User className="h-7 w-7 rounded-full p-1 border-2 border-primary/50 text-primary" />
                    </div>
